...
function AddProduct() {
    ...
    const sizeCategories = ["Men", "Woman"];
    ...
    // Check if selected category needs sizes
    const hasSizes = sizeCategories.includes(
            ...
            if (hasSizes) {
                ...
                formData.append(
                    ...
                    JSON.stringify([
                        {
                            size: "oneSize",
                            stock: Number(data.sizes[0].stock),
                        },
                    ])
                );
            }
    ...
    return (
        <div className="relative min-h-screen bg-slate-50 p-6 flex justify-center items-start">
                        ...
                        <CircularProgress
                            ...
                            sx={{
                                ...
                                [`& .MuiCircularProgress-circle`]: {
                                    strokeLinecap: "round",
                                    filter:
                                        "drop-shadow(0px 0px 8px rgba(79, 70, 229, 0.4))",
                                },
                            }}
                            size={70}
                            thickness={4}
            ...
            <div
                className={`w-full max-w-5xl bg-white shadow-sm border border-slate-200 overflow-hidden rounded-2xl transition-all ${loading
                                ...
                                <div className="grid grid-cols-4 gap-3 mt-4">
                                    ...
                                    {previewImages.map(
                                        (img, index) => (
                                            <div
                                                key={index}
                                                className="relative group border border-slate-200 rounded-lg overflow-hidden h-20"
                                            >
                                                <img
                                                    src={img}
                                                    alt="preview"
